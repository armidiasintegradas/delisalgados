-- DELI SALGADOS — V3.9 PAYMENT PLAN ORDER RPC
...
begin
  ...
  select jsonb_build_object(
    ...
    'payment_plan', o.payment_plan, 'payment_method', o.payment_method,
    'payment_status', o.payment_status, 'deposit_percentage', o.deposit_percentage,
    'amount_due_now', o.amount_due_now, 'amount_paid', o.amount_paid,
